...
dist_patch_DATA =						\
  ...
  %D%/packages/patches/python-keystoneauth1-requirements.patch \
  ...
  %D%/packages/patches/python-requestsexceptions-requirements.patch	\
  ...
  %D%/packages/patches/snappy-enable-rtti.patch		\
