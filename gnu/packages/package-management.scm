  ...
  (let ((version "1.4.0")
    ...
    (package
      ...
      (source (origin
                ...
                (sha256
                 (base32
                  "0nrn4a1zc9v85409211rf0gi3kcvycclbaifab9wjdaihiy4cvxr"))
...
(define-public arctype-guix
  (package
    (inherit guix)
    (name "arctype-guix")
    (version "2cd40917d3057e7dcb293fdd8fe6026d5450669a")
    (source
      (origin
        (method git-fetch)
        (uri (git-reference
        ...
        (sha256
          (base32
            "11qij8inzxqkzsv4vslfxrlfp6h4iijm8f78ln3yfv2zcs8wccm0"))
